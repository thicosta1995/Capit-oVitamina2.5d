...
public class MaquinaEstados : MonoBehaviour
{
    ...
    [SerializeField] float velocidadePadr„o;
    ...
    void Update()
    {
        ...
        if (atacado == true && timeFrenezi <= 8)
        {
            ...
            velocidadePatrulha = velocidadePersiguiÁ„o;
            frenezi = true;
        }

        else if (frenezi == true) 
        {
            velocidadePatrulha = velocidadePadr„o;
            atacado = false;
            frenezi = false;
            timeFrenezi = 0;
        }
   ...
   private bool CondicionalparaSeVirar()
    ...
    // void arremeÁarProjetil(Vector3 TargetPosition, Vector3 StartPosition)
    //{
